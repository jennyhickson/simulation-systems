...
* The description box will contain a pull request template to fill out
  ...
  required and testing performed. This can be completed now, or edited later
  before passing to review.

Finally, ensure that the option to allow edits by maintainers box
...
final fixes based on continuous integration. **If you use draft mode mark the pull
request as ``ready for review`` once you are satisfied.**
